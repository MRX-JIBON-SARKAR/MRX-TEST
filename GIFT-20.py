...
ha = current.day
today = date.today()
#JIBON2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-JIBON/1.2.0 OPN-B'
...
def main():
    ...
    print(f"\033[1;97m[\033[92;1m1\033[1;97m]\033[1;33mBANGLADESH ID CLONE  ")
    print(f"\033[1;97m[\033[92;1m2\033[1;97m]\033[1;35mPAKISTAN ID CLONE  ")
