...
def pass1():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for guru in user:
            ...
            pwx = [kode+kodex+kod+guru,kod+guru,kodex+guru,kode+kodex+kod,'@@@###','nusrat','jannat','sadiya','jibon123','angel sadia','123@@@','bangladesh','i love you','Bangladesh','free fire','Free fire','I love you','Md Sakib Hasan',]
